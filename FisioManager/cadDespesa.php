...
if (isset($_POST['cadDespesa'])) {					
	...
	$insereReceita = $pdo->prepare("INSERT INTO despesa (descricao, 
														 valor, 
														 data,
														 hora
														 ) 
...
?>
            ...
            <div class="container">
				...
				<div class="card">
                <div class="card-body">
                <h5 class="card-title">Cadastro de Despesas</h5>
				<form method="POST">
				<div class="form-row">
			    ...
			    <a href="indexDespesas.php" type="button" class="btn btn-info" style="width: 9%; margin-right: 10px; height: 8%;">Voltar</a>
    				<button style="width: 11%;" type="submit" name="cadDespesa" class="btn btn-success">
    					Cadastrar
    				</button>
				</form>
				</div>
