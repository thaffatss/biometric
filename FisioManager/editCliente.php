<?php	
			...
			error_reporting(E_ALL | E_STRICT);
				...
				if(isset($_GET['id'])) {	
					...
					if (($erro_nome_cliente) == 0) {
						...
						$updateCliente = $pdo->prepare("UPDATE cliente
														   SET nome     		 = ?, 
														   	   idade       		 = ?, 
															   peso    		     = ?,
															   altura   		 = ?,
		...
		?>			
					<?php
					if(isset($_GET['id'])) {
						$buscaCliente = $pdo->prepare('SELECT   idCliente, 
																nome, 
																idade, 
																peso, 
																altura, 
						...
						?>
									<form method="POST" style="margin-bottom: 100px;">
										<div class="container" style="margin-bottom: 30px;">
											...
											<input type="id" name="id" value="<?php echo $mostre->idCliente; ?>" hidden>
											...
											<div class="form-row">
												...
												<div class="form-group col-md-4">
													...
													<select name="plano" class="form-control" required autocomplete="off" aria-placeholder="Aqui">
															...
															$buscarClientePlano = $pdo->prepare("SELECT * FROM cliente WHERE idCliente ='".$_GET['id']."'");
											...
											<div class="form-row">
												...
												<div class="form-group col-md-12">
												    ...
												    <a href="indexCliente.php" type="button" class="btn btn-info" style="width: 8%; margin-right: 10px; height: 8%;">Voltar</a>
