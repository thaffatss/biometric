<?php	
			...
			error_reporting(E_ALL | E_STRICT);
				...
				if(isset($_GET['id'])) {	
					...
					if (($erro_nome_cliente) == 0) {
						...
						$updateCliente = $pdo->prepare("UPDATE cliente_estetica
														   SET nome     		 = ?, 
														   	   idade       		 = ?, 
															   peso    		     = ?,
															   altura   		 = ?,
		...
		?>			
					<?php
					if(isset($_GET['id'])) {
						$buscaCliente = $pdo->prepare('SELECT   idCliente_estetica, 
																nome, 
																idade, 
																peso, 
																altura, 
						...
						?>
									<form method="POST" style="margin-bottom: 100px;">
										<div class="container" style="margin-bottom: 30px;">
											...
											<input type="id" name="id" value="<?php echo $mostre->idCliente_estetica; ?>" hidden>
											...
											<div class="form-row">
												...
												<div class="form-group col-md-12">
												    ...
												    <a href="indexCliente_Derm.php" type="button" class="btn btn-info" style="width: 8%; margin-right: 10px; height: 8%;">Voltar</a>
