<?php	
			...
			error_reporting(E_ALL | E_STRICT);
				...
				if(isset($_GET['id'])) {	
					...
					if (($erro_nome_cliente) == 0) {
						...
						$updateCliente = $pdo->prepare("UPDATE cliente_reabilitacao
														   SET nome     		 = ?, 
														   	   idade       		 = ?, 
															   peso    		     = ?,
															   altura   		 = ?,
						...
						$updateCliente->bindValue(2, $idade);	
						$updateCliente->bindValue(3, $peso); 	
						$updateCliente->bindValue(4, $altura);	
						$updateCliente->bindValue(5, $cpf);	
						$updateCliente->bindValue(6, $telefone);
						$updateCliente->bindValue(7, $saldo);
						$updateCliente->bindValue(8, $preco);
						$updateCliente->bindValue(9, $sessoes);
						$updateCliente->bindValue(10, $profissao); 
						$updateCliente->bindValue(11, $endereco);
						$updateCliente->bindValue(12, $procedimento);
						$updateCliente->bindValue(13, $descricao);
						$updateCliente->bindValue(14, $atestado);
						$updateCliente->bindValue(15, $dados['opcao1'], PDO::PARAM_INT);
						$updateCliente->bindValue(16, $dados['opcao2'], PDO::PARAM_INT);
						$updateCliente->bindValue(17, $dados['opcao3'], PDO::PARAM_INT);
						$updateCliente->bindValue(18, $dados['opcao4'], PDO::PARAM_INT);
						$updateCliente->bindValue(19, $dados['opcao5'], PDO::PARAM_INT);
						$updateCliente->bindValue(20, $dados['opcao6'], PDO::PARAM_INT);
						$updateCliente->bindValue(21, $dados['opcao7'], PDO::PARAM_INT);
						$updateCliente->bindValue(22, $dados['opcao8'], PDO::PARAM_INT);
						$updateCliente->bindValue(23, $dados['opcao9'], PDO::PARAM_INT);
						$updateCliente->bindValue(24, $dados['opcao10'], PDO::PARAM_INT);
						$updateCliente->bindValue(25, $dados['opcao11'], PDO::PARAM_INT);
						$updateCliente->bindValue(26, $dados['opcao12'], PDO::PARAM_INT);
						$updateCliente->bindValue(27, $dados['opcao13'], PDO::PARAM_INT);
						$updateCliente->bindValue(28, $dados['opcao14'], PDO::PARAM_INT);
						$updateCliente->bindValue(29, $dados['opcao15'], PDO::PARAM_INT);
						$updateCliente->bindValue(30, $dados['opcao16'], PDO::PARAM_INT);
						$updateCliente->bindValue(31, $dados['opcao17'], PDO::PARAM_INT);
						$updateCliente->bindValue(32, $dados['opcao18'], PDO::PARAM_INT);
		...
		?>			
					<?php
					if(isset($_GET['id'])) {
						$buscaCliente = $pdo->prepare('SELECT   idCliente_reabilitacao, 
																nome, 
																idade, 
																peso, 
																altura, 
						...
						?>
									<form method="POST">
										<div class="container" style="margin-bottom:100px;">
											...
											<input type="id" name="id" value="<?php echo $mostre->idCliente_reabilitacao; ?>" hidden>
											...
											<div class="form-row">
												...
												<div class="form-group col-md-4">
													...
													<select name="plano" class="form-control" required autocomplete="off" aria-placeholder="Aqui">
															...
															$buscarClientePlano = $pdo->prepare("SELECT * FROM cliente_reabilitacao WHERE idCliente_reabilitacao ='".$_GET['id']."'");
											...
											<div class="form-row">
												<div class="form-group col-md-12">
													...
													<textarea class="form-control" style="font-size:12px;" name="descricao" id="descricao"  rows="27" placeholder="1 - Infecção recente, Qual:?&#10;2 - Problemas Neurológicos, Qual:?&#10;3 - Doença Respiratória, Qual:?&#10;&#10;4 - Outras Anotações:"><?php echo $mostre->descricao;?></textarea>
												</div>
											</div>
											<div class="form-row">
												<div class="form-group col-md-12">
													<label for= "atestado">Atestado</label><br>
													<textarea class="form-control" style="font-size:12px;" name="atestado" id="atestado"  rows="27" placeholder="Descreva o atestado aqui!"><?php echo $mostre->atestado;?></textarea>
												</div>
											</div>
												<!-- QUESTIONÁRIO -->
												<div class="form-group col-md-12">
													...
													<a href="indexCliente_Reabilitacao.php" type="button" class="btn btn-info" style="width: 8%; margin-right: 10px; height: 8%;">Voltar</a>
