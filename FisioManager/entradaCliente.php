...
if (isset($_SESSION['id_usuario'])) {
	...
	if (isset($_POST['cadCliente'])) {
		...
		if (
			...
			$insereCliente = $pdo->prepare("INSERT INTO cliente (dataEntrada, 
														 horaEntrada, 
														 nome,
														 cpf,
														 saldo,
...
?> <br>
	<div class="container">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Cadastro Quiropraxia</h5>
						<?= $erro1; ?>
						<form method="POST">
							<div class="form-row">
							...
							<a href="indexFluxo.php" type="button" class="btn btn-info" style="width: 9%; margin-right: 10px; height: 8%;">Voltar</a>
