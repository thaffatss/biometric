...
if (isset($_SESSION['id_usuario'])) {
	...
	if (isset($_POST['cadCliente'])) {
		...
		if (
			...
			$insereCliente = $pdo->prepare("INSERT INTO cliente_estetica (dataEntrada, 
														 horaEntrada, 
														 nome,
														 cpf,
														 saldo,
...
?>
	...
	<div class="container">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Cadastro Derm</h5>
					<?= $erro1; ?>
					<form method="POST">
						<div class="form-row">
							<div class="form-group col-md-6">
								<label for="dataEntrada">Data de Entrada*</label><br />
								<input type="date" name="dataEntrada" class="form-control" autocomplete="off">

							</div>
							<div class="form-group col-md-6">
								<label for="horaEntrada">Hora de Entrada*</label><br />
								<input type="time" name="horaEntrada" class="form-control" autocomplete="off">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-6">
						...
						<a href="indexFluxo_Derm.php" type="button" class="btn btn-info" style="width: 9%; margin-right: 10px; height: 8%;">Voltar</a>
