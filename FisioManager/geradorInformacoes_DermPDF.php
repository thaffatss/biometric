...
if(isset($_GET["id"])){
    ...
    if(count($row) > 0) {
       ...
       <div class='container'>
       <dl class='row' >
           <dd class='col-sm-12' style='padding-bottom:30px; padding-left:18%;'><h2>INFORMAÇÕES DO PACIENTE - DERM</h2></dd>
           <dd class='col-sm-12' style='padding-left:80%; margin-top:-30px;'><img src='img/logo.jpg' alt='Logo'></dd>

           <dd class='col-sm-12' style='padding-bottom:5px;'>ID: ".$dado['idCliente_estetica']."</dd>
