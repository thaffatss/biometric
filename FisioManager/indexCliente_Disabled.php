...
?>
		...
		<div class="row" style="margin-left:10px; margin-top: 15px; margin-right: 10px;">
			...
			<div class="card">
				<div class="card-body">
				<h5 class="card-title">Alunos Quiropraxia - Desabilitado(s)
								...
								<tbody id="searchTable">
									...
									->prepare(
										...
										FROM
                                            ...
                                            WHERE c.disabled = 0 ORDER BY c.idCliente DESC'
									);
										...
										foreach ($row as $key => $value) { ?>
											...
											<tr style="background-color: #FF00004B;">
												<td style="font-size: 16px; text-align: center;" title="Habilitar Aluno">
													<a href="enabledCliente.php?id=<?php echo $value['codigo']; ?>&desbloquear=<?= 1 ?>" data-confirm-enabled-paciente > <i class="bi-x-circle-fill" style="color: green;"></i> </a>
												</td>
                                                ...
                                                <td style="font-size: 16px; text-align: center; width:60px;">
                                                    <a title ='Editar Aluno' href='editCliente.php?id=<?php echo $value['codigo']; ?>' data-confirm-edit='Tem certeza de que deseja editar esse item selecionado?' style="margin-left: 5px;">
														<i class="bi bi-pencil" style="color: #007FB9;"></i>
													</a>
                                                    <a title ='Deletar Aluno' href='deleteCliente.php?id=<?php echo $value['codigo']; ?>' data-confirm-del='Tem certeza de que deseja excluir o item selecionado?' style="margin-left: 5px;">
