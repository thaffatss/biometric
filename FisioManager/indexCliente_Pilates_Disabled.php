...
?>
		...
		<div class="row" style="margin-left:10px; margin-top: 15px; margin-right: 10px;">
			...
			<div class="card">
				<div class="card-body">
				<h5 class="card-title">Pacientes Pilates - Desabilitado(s)
										...
										foreach ($row as $value) { 
											...
											<tr style="background-color: #FF00004B;">
                                                ...
                                                <td style="font-size: 16px; text-align: center; width:60px;">
                                                    <a title ='Editar Paciênte' href='editCliente_Pilates.php?id=<?php echo $value['codigo']; ?>&p=<?php echo $value['Planos_idPlano']; ?>' data-confirm-edit='Tem certeza de que deseja editar esse item selecionado?' style="margin-left: 5px;">
														<i class="bi bi-pencil" style="color: #007FB9;"></i>
													</a>
                                                    <a title ='Deletar Paciênte' href='deleteCliente_Pilates.php?id=<?php echo $value['codigo']; ?>' data-confirm-del='Tem certeza de que deseja excluir o item selecionado?' style="margin-left: 5px;">
