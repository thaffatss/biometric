...
?>
		...
		<div class="row" style="margin-left:10px; margin-top: 15px; margin-right: 10px;">
			...
			<div class="card">
				<div class="card-body">
				<h5 class="card-title">Pacientes Reabilitação - Desabilitado(s)
					<a href="indexCliente_Reabilitacao.php">
						<i class="bi bi-person-check-fill" title="Pacientes Habilitados" style=" color: green; font-size: 2rem; margin-right:5px; float: right; padding-bottom: 10px;"></i>
					</a>
				</h5>
				<!-- Advanced Tables -->
