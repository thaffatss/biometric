						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" 
								...
								<tbody id="searchTable">
									...
									$buscarReceitas = $pdo->prepare('SELECT * FROM despesa');
									...
									?>
											...
											<tr>
												<td style="font-size: 12px; text-align: center;"><?=$value['idDespesa'];?></td>
												...
												<td style="font-size: 16px; text-align: center; width:60px;">
                                                    <a title ='Editar Despesa' href='editDespesa.php?id=<?php echo $value['idDespesa']; ?>' data-confirm-edit-despesa='Tem certeza de que deseja editar esse item selecionado?' style="margin-left: 5px;">
														<i class="bi bi-pencil"></i>
													</a>
                                                    <a title ='Deletar Despesa' href='deleteDespesa.php?id=<?php echo $value['idDespesa']; ?>' data-confirm-del-despesa='Tem certeza de que deseja excluir o item selecionado?' style="margin-left: 5px;">
