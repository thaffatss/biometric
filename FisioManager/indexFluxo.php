									...
									<tbody id="searchTable">
										...
										$buscaCliente = $pdo
											->prepare(
												...
												c.saldo AS saldo, c.status_pago AS pago, c.pc_valor AS preco
										FROM
											cliente c
										    JOIN pagamento pg
											...
											foreach ($row as $value) { ?>
												...
												<tr>
													...
													<td style="font-size: 16px; text-align: center;">
														...
														if (($value['pago']) == 0) {
														?>
															<a title='Sinalizar Pagamento' href='sinalizarPagamento.php?id=<?php echo $value['codigo']; ?>' data-confirm-payment>
