...
if(count($row) > 0) {
    foreach ($row as $value) {
        ...
        $resultado .= '<a title="Gerar PDF" href="geradorInformacoes_DermPDF.php?id='.$id.'" target="_blank"><i style="float:right; font-size: 2rem; color: cornflowerblue;" class="bi bi-printer-fill"></i></a>';
        ...
        $resultado .='<dd class="col-sm-4" style="font-size:12px; margin:0px; padding:0px;">'.$value['idCliente_estetica'].'</dd>';
