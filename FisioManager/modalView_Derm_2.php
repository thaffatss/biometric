...
if(count($row) > 0) {
    foreach ($row as $value) {
        ...
        $resultado .= '<a title="Gerar PDF" href="geradorAtestadoDermPDF.php?id='.$id.'" target="_blank"><i style="float:right; font-size: 2rem; color: cornflowerblue;" class="bi bi-printer-fill"></i></a>';
