...
if(count($row) > 0) {
    foreach ($row as $value) {
        ...
        $resultado .= '<a title="Gerar PDF" href="geradorInformacoesPDF.php?id='.$id.'" target="_blank"><i style="float:right; font-size: 2rem; color: cornflowerblue;" class="bi bi-printer-fill"></i></a>';
        ...
        $resultado .='<dd class="col-sm-4" style="font-size:12px; margin:0px; padding:0px;">'.$value['idCliente'].'</dd>';
        ...
        $resultado .='<dd class="col-sm-9" style="font-size:12px; margin:0px; padding:0px;">'.$value['procedimento'].'</dd><br><br>';
