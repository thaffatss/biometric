								...
								<tbody>
									<tr>
										<td style="width: 100%; text-align:center;">
											<h2>RELATÓRIO P/ TOMADA DE DECISÕES - DERM</h2><br>
										</td>
										<td style="width: 10%;">
											<a title ='Gerar PDF' 
												href='relatorioDecisaoDermPDF.php' accesskey="2" target="_blank">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" 
								...
								<tbody id="searchTable">
									...
									<?php
									$buscaCliente1 = $pdo
									->prepare("SELECT COUNT(ce.idCliente_estetica) AS qtdAtm, ce.status_pago FROM cliente_estetica ce WHERE ce.dataEntrada BETWEEN'".$date1."'AND'".$date2."'");
									...
									$buscaCliente2 = $pdo
									->prepare("SELECT COUNT(ce.idCliente_estetica) AS qtdDev, ce.status_pago FROM cliente_estetica ce WHERE ce.dataEntrada BETWEEN'".$date1."'AND'".$date2."' AND ce.status_pago = 0");
									...
									$buscaCliente3 = $pdo
									->prepare("SELECT SUM(ce.pc_valor) + SUM(ce.saldo) AS subTotal, COUNT(ce.idCliente_estetica) AS qtdPago, ce.status_pago FROM cliente_estetica ce WHERE ce.dataEntrada BETWEEN'".$date1."'AND'".$date2."' AND ce.status_pago = 1");
