          ...
          $date2 = $_SESSION['date2'];
                                ...
                                <table class='table table-bordered table-sm'>
                                                ...
                                                $html .="<tr>
                                                    ...
                                                    <td style='font-size: 8px; text-align: center;' id='dt'>".date('d/m/Y', strtotime($value['dt_inicio']))."</td>

                                                    <td style='font-size: 8px; text-align: center;' id='hr'>".date('d/m/Y', strtotime($value['dt_fim']))."</td>
