...
<div class="col-md-12">
				...
				<div class="panel panel-default">
								...
								<tbody>
									<tr>
										<td style="width: 100%; text-align:center;">
											<h2>RELATÓRIO DE CLIENTE(S) INADIMPLENTE - DERM</h2><br>
										</td>
										<td style="width: 10%;">
					...
					<?php
					$buscaClienteQtd = $pdo->prepare("SELECT count(*) AS qtd FROM cliente_estetica WHERE status_pago = 0");
								...
								<tbody id="searchTable">
									...
									->prepare(
										"SELECT
											...
											ce.dataEntrada AS dt_entrada, ce.horaEntrada AS hr_entrada, ce.profissao AS profissao, ce.sessoes AS sessoes, 
											ce.status_pago AS pago, ce.pc_valor AS preco,
											ce.endereco AS endereco, ce.telefone AS tel
										FROM cliente_estetica ce
										WHERE ce.status_pago = 0"
									);
