...
<div class="col-md-12">
				...
				<div class="panel panel-default">
								...
								<tbody>
									<tr>
										<td style="width: 100%; text-align:center;">
											<h2>RELATÓRIO DE CLIENTE(S) ADIMPLENTE - DERM</h2><br>
										</td>
										<td style="width: 10%;">
					...
					<?php
					$buscaClienteQtd = $pdo->prepare("SELECT count(*) AS qtd FROM cliente_estetica WHERE status_pago = 1");
