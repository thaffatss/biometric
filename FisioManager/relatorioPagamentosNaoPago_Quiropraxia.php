...
<div class="col-md-12">
				...
				<div class="panel panel-default">
								...
								<tbody>
									<tr>
										<td style="width: 100%; text-align:center;">
											<h2>RELATÓRIO DE CLIENTE(S) INADIMPLENTE - QUIROPRAXIA</h2><br>
										</td>
										<td style="width: 10%;">
					...
					<?php
					$buscaClienteQtd = $pdo->prepare("SELECT count(*) AS qtd FROM cliente WHERE status_pago = 0");
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" 
								...
								<tbody id="searchTable">
									...
									->prepare(
										"SELECT
											c.idCliente AS codigo, c.nome AS cliente, c.cpf AS cpf,
											c.dataEntrada AS dt_entrada, c.horaEntrada AS hr_entrada, c.profissao AS profissao, c.sessoes AS sessoes, 
											c.status_pago AS pago, c.pc_valor AS preco,
											c.endereco AS endereco, c.telefone AS tel
										FROM cliente c
										WHERE c.status_pago = 0"
									);
									...
									?>
											<tr>
												...
												<td alt="" style="font-size: 12px; text-align: center;"><?=date('H:i:s', strtotime($value['hr_entrada']))?></td>
